...
Route::middleware(['auth', 'verified'])->controller(EstoqueController::class)->group(function () {
    ...
    Route::get('registros/estoque/unificado', 'listarUnificado')->name('estoque.unificado');
    Route::get('registros/estoque/exportar', 'exportarEstoqueLocalizacao')->name('estoque.exportar');
